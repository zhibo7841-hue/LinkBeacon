...
internal fun Any?.testText(): String = when (this) {
    ...
    is Int -> {
        val key = com.networktoolbox.feature.history.R.string::class.java.fields
...
internal fun assertPresentationEquals(expected: Any?, actual: Any?) {
    fun normalize(value: Any?): Any? = when (value) {
        ...
        is Int -> if (com.networktoolbox.feature.history.R.string::class.java.fields.any { it.getInt(null) == value }) value.testText() else value
